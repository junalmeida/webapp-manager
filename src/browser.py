...
SUPPORTED_BROWSERS = [Browser(BrowserType.BROWSER_TYPE_FIREFOX, "Firefox", "firefox", f"{OS_BIN}/firefox", "firefox"),
                ...
                Browser(BrowserType.BROWSER_TYPE_FIREFOX_FLATPAK, "Firefox (Flatpak)", "/var/lib/flatpak/exports/bin/org.mozilla.firefox", "/var/lib/flatpak/exports/bin/org.mozilla.firefox", "org.mozilla.firefox"),
                Browser(BrowserType.BROWSER_TYPE_FIREFOX_FLATPAK, "Firefox (Flatpak)", ".local/share/flatpak/exports/bin/org.mozilla.firefox", ".local/share/flatpak/exports/bin/org.mozilla.firefox", "org.mozilla.firefox"),
                ...
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Chrome (Flatpak)", "/var/lib/flatpak/exports/bin/com.google.Chrome", "/var/lib/flatpak/exports/bin/com.google.Chrome", "com.google.Chrome"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Chrome (Flatpak)", ".local/share/flatpak/exports/bin/com.google.Chrome", ".local/share/flatpak/exports/bin/com.google.Chrome", "com.google.Chrome"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Chromium", "chromium", f"{OS_BIN}/chromium", "chromium-browser"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Chromium (chromium-browser)", "chromium-browser", f"{OS_BIN}/chromium-browser", "chromium-browser"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Chromium (Snap)", "chromium", "/snap/bin/chromium", "chromium"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Chromium (Bin)", "chromium-bin", f"{OS_BIN}/chromium-bin-browser", "chromium-browser"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Ungoogled Chromium", "ungoogled-chromium", f"{OS_BIN}/ungoogled-chromium", "ungoogled-chromium"),
                ...
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Ungoogled Chromium (Flatpak)", "/var/lib/flatpak/exports/bin/io.github.ungoogled_software.ungoogled_chromium", "/var/lib/flatpak/exports/bin/io.github.ungoogled_software.ungoogled_chromium", "io.github.ungoogled_software.ungoogled_chromium"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Ungoogled Chromium (Flatpak)", ".local/share/flatpak/exports/bin/io.github.ungoogled_software.ungoogled_chromium", ".local/share/flatpak/exports/bin/io.github.ungoogled_software.ungoogled_chromium", "io.github.ungoogled_software.ungoogled_chromium"),
                ...
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Edge (Flatpak)", "/var/lib/flatpak/exports/bin/com.microsoft.Edge", "/var/lib/flatpak/exports/bin/com.microsoft.Edge", "com.microsoft.Edge"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Edge (Flatpak)", ".local/share/flatpak/exports/bin/com.microsoft.Edge", ".local/share/flatpak/exports/bin/com.microsoft.Edge", "com.microsoft.Edge"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Brave (Flatpak)", "/var/lib/flatpak/exports/bin/com.brave.Browser", "/var/lib/flatpak/exports/bin/com.brave.Browser", "com.brave.Browser"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Brave (Flatpak)", ".local/share/flatpak/exports/bin/com.brave.Browser", ".local/share/flatpak/exports/bin/com.brave.Browser", "com.brave.Browser"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Yandex", "yandex-browser", f"{OS_BIN}/yandex-browser", "yandex-browser"),
                Browser(BrowserType.BROWSER_TYPE_FALKON, "Falkon (Flatpak)", "/var/lib/flatpak/exports/bin/org.kde.falkon", "/var/lib/flatpak/exports/bin/org.kde.falkon", "org.kde.falkon"),
                Browser(BrowserType.BROWSER_TYPE_FALKON, "Falkon (Flatpak)", ".local/share/flatpak/exports/bin/org.kde.falkon", ".local/share/flatpak/exports/bin/org.kde.falkon", "org.kde.falkon"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Naver Whale", "naver-whale-stable", f"{OS_BIN}/naver-whale-stable", "naver-whale"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Yandex (Flatpak)", "/var/lib/flatpak/exports/bin/ru.yandex.Browser", "/var/lib/flatpak/exports/bin/ru.yandex.Browser", "ru.yandex.Browser"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Yandex (Flatpak)", ".local/share/flatpak/exports/bin/ru.yandex.Browser", ".local/share/flatpak/exports/bin/ru.yandex.Browser", "ru.yandex.Browser"),
                Browser(BrowserType.BROWSER_TYPE_CHROMIUM, "Thorium", "thorium-browser", f"{OS_BIN}/thorium-browser", "thorium-browser"),
                Browser(BrowserType.BROWSER_TYPE_FIREFOX, "Floorp", "floorp", f"{OS_BIN}/floorp", "floorp"),
                Browser(BrowserType.BROWSER_TYPE_FLOORP_FLATPAK, "Floorp (Flatpak)", "/var/lib/flatpak/exports/bin/one.ablaze.floorp", "/var/lib/flatpak/exports/bin/one.ablaze.floorp", "one.ablaze.floorp"),
                Browser(BrowserType.BROWSER_TYPE_FLOORP_FLATPAK, "Floorp (Flatpak)", ".local/share/flatpak/exports/bin/one.ablaze.floorp", ".local/share/flatpak/exports/bin/one.ablaze.floorp", "one.ablaze.floorp")
                ]
